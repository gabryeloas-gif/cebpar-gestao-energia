...
app.post('/api/auth/setup', async c => {
  ...
  if (!b.name || !b.email || typeof b.password !== 'string' || b.password.length < 10) return c.json({ error: 'Informe nome, e-mail e senha com pelo menos 10 caracteres.' }, 400);
